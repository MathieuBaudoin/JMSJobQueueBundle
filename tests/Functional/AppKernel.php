...
class AppKernel extends Kernel
{
    ...
    {
        return sys_get_temp_dir() . 'AppKernel.php/' .Kernel::VERSION.'/JMSJobQueueBundle/'.substr(sha1($this->config), 0, 6).'/cache';
    }
    ...
    {
        return sys_get_temp_dir() . 'AppKernel.php/' .Kernel::VERSION.'/JMSJobQueueBundle/'.substr(sha1($this->config), 0, 6).'/logs';
    }
