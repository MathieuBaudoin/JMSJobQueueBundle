...
use JMS\JobQueueBundle\Filter\JobFilter;
...
class JobController
{
    public function __construct(private readonly JobRepository $jobManager, private readonly ManagerRegistry $managerRegistry,
    ...
    public function overview(Request $request): Response
    {
        ...
        return new Response($this->twig->render('Job/overview.html.twig', array(
    ...
    public function details(Job $job): Response
    {
        ...
        return new Response($this->twig->render('Job/details.html.twig', [
            'job' => $job,
     ...
     */
    #[Route("/{id}/retry", name: "jms_jobs_retry")]
