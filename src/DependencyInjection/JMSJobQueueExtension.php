...
use JMS\JobQueueBundle\Type\SafeObjectType;
...
class JMSJobQueueExtension extends Extension implements PrependExtensionInterface
{
    ...
    public function load(array $configs, ContainerBuilder $container): void
    {
        ...
        if ($config['statistics']) {
            $loader->load('statistics.yaml');
        }*/

        $container->registerForAutoconfiguration(JobScheduler::class)->addTag('jms_job_queue.scheduler');
        $container->registerForAutoconfiguration(CronCommand::class)->addTag('jms_job_queue.cron_command');
