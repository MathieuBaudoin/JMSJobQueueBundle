...
class RunCommand extends Command
{
    ...
    public function __construct(ManagerRegistry $managerRegistry, JobRepository $jobManager, EventDispatcherInterface $dispatcher, array $queueOptionsDefault, array $queueOptions)
    {
        parent::__construct();
